  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl p-4 sm:p-5 md:p-8 lg:p-10 lg:py-16">
        ...
        <hr className="my-5 sm:my-6 border-gray-200 sm:mx-auto lg:my-8" />
        ...
        <div className="text-center">
          ...
          >
            <img src="/images/favicon.ico" className="mr-3 h-6 sm:h-7 md:h-10" alt="GMAJOR Favicon" />
            <img src="/images/gmajor-logo.png" className="w-[100px] sm:w-[120px]" alt="GMAJOR logo" />
          </a>
          ...
          <ul className="mt-4 sm:mt-5 flex justify-center space-x-5 sm:space-x-6">
            <li>
              <a
            ...
            <li>
              <a
                ...
                className="text-gray-500 hover:text-gray-900"
              >
                <svg className="h-5 w-5 sm:h-6 sm:w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
