      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="space-y-6 w-full md:w-[400px]">
            <h2 className="text-3xl lg:text-5xl font-black text-blue-900 lg:leading-[1.2] uppercase">
          ...
          {/* Right */}
          <div className="flex flex-col gap-6 w-full lg:w-[700px] ml-0 lg:ml-8 mt-8 lg:mt-0">
            {/* Row 1 */}
            <div className="md:flex gap-4">
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                              w-full md:w-[440px] h-auto md:h-[200px]
                              flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">NGÔN NGỮ</h3>
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                ...
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">THÔNG TIN</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
            ...
            <div className="md:flex gap-4">
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                              ...
                              flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">TIẾP CẬN</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                              w-full md:w-[440px] h-auto md:h-[200px]
                              flex flex-col justify-center items-center text-center mt-4 md:mt-0">
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">NHÂN LỰC</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
            ...
            <div className="md:flex gap-4">
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                              ...
                              flex flex-col justify-center items-center text-center">
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">NGÂN SÁCH</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-100
                              ...
                              flex flex-col justify-center items-center text-center mt-4 md:mt-0">
                <h3 className="text-2xl font-black text-blue-900 uppercase mb-2">BẮT ĐẦU</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
