        ...
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="flex flex-col gap-4 sm:gap-5 lg:gap-6 w-full lg:w-[700px] ml-0 lg:ml-8 mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="md:flex gap-4">
              <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4 border border-gray-100
                              w-full md:w-[440px] h-auto md:h-[200px]
                              flex flex-col justify-center items-center text-center">
                <h3 className="text-lg sm:text-xl md:text-2xl font-black text-blue-900 uppercase mb-1.5 sm:mb-2">
                  NGÔN NGỮ
                </h3>
                <p className="text-[13px] sm:text-sm md:text-[15px] lg:text-base text-gray-700 leading-relaxed md:leading-6">
