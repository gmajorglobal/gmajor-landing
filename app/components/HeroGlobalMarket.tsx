  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1280px] px-3 sm:px-4 md:px-6 py-8 sm:py-12 md:py-14 lg:py-16">
        ...
        <div
          className="group relative h-[520px] sm:h-[580px] md:h-[580px] lg:h-[580px] w-full overflow-hidden rounded-md
        ...
        >
          ...
          <div className="absolute left-4 sm:left-6 md:left-10 lg:left-12 top-32 sm:top-[120px] md:top-[120px] lg:top-[20px] w-[94%] sm:w-[540px] md:w-[620px] lg:w-[700px]">
            <div
            ...
            >
              ...
              <div className="px-4 py-5 sm:px-6 sm:py-8 md:px-8 md:py-10 lg:px-8 lg:py-12">
                ...
                <h1 className="mb-8 text-[24px] sm:text-[34px] md:text-[40px] lg:text-[46px] leading-[32px] sm:leading-[38px] md:leading-[46px] lg:leading-[52px] font-extrabold tracking-[0.02em] uppercase whitespace-pre-line">
          ...
          <a
            ...
            className="absolute left-4 sm:left-6 md:left-10 lg:left-12 bottom-4 sm:bottom-5 md:bottom-6 lg:bottom-6 inline-flex items-center gap-3 sm:gap-4 md:gap-5 rounded-full bg-[#ff4444] px-5 sm:px-6 md:px-7 lg:px-8 py-3 sm:py-3.5 md:py-4 text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] font-semibold text-white shadow-md
                       transform-gpu motion-safe:transition-transform motion-safe:duration-300
                       hover:scale-105 hover:bg-[#ff3333] active:scale-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/60"
          >
            ...
            <span className="grid h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 place-items-center rounded-full bg-white shadow-inner">
              <svg viewBox="0 0 20 20" className="h-4 w-4 sm:h-5 sm:w-5 text-[#ff4444]" fill="currentColor" aria-hidden="true">
